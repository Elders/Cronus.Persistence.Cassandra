...
%FAKE% %NYX% "target=%TARGET%"  appName=Elders.Cronus.Persistence.Cassandra appType=nuget appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Cronus.Persistence.Cassandra