...
{
    public class OldCassandraEventStorePlayer : IMigrationEventStorePlayer
    {
        ...
        public OldCassandraEventStorePlayer(MigratorCassandraReplaySettings settings, ILogger<OldCassandraEventStorePlayer> logger)
        {
